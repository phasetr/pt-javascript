        ...
        <table className="min-w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700">
          <thead>
            <tr className="bg-gray-100 dark:bg-gray-700">
              ...
              <th className="py-2 px-4 border-b border-gray-200 dark:border-gray-600 text-left">会社名</th>
              <th className="py-2 px-4 border-b border-gray-200 dark:border-gray-600 text-left">担当者名</th>
            </tr>
          </thead>
          <tbody>
            {customers.map((customer) => (
              <tr key={customer.CustomerId} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                <td className="py-2 px-4 border-b border-gray-200 dark:border-gray-600">{customer.CustomerId}</td>
                <td className="py-2 px-4 border-b border-gray-200 dark:border-gray-600">{customer.CompanyName}</td>
                <td className="py-2 px-4 border-b border-gray-200 dark:border-gray-600">{customer.ContactName}</td>
              </tr>
            ))}
          </tbody>
        </table>
