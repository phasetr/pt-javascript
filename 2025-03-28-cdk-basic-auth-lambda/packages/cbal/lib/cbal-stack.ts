...
export class CbalStack extends Stack {
	constructor(scope: Construct, id: string, props?: StackProps) {
		...
		const appConfigSecret = new secretsmanager.Secret(
			this,
			`${resourcePrefix}AppConfigSecret`,
			{
		...
		const basicAuthSecret = new secretsmanager.Secret(
			this,
			`${resourcePrefix}BasicAuthSecret`,
			{
